...
func (s *endpointPrintDocument) PrintDocument(ctx context.Context, id *uuid.UUID, PrintDocumentArg *PrintDocumentArg) (*PrintFile, *Response, error) {
	path := fmt.Sprintf("%s/export", id)
	rb := NewRequestBuilder[CustomTemplate](s.Endpoint, ctx).WithPath(path).WithBody(PrintDocumentArg).setContentHeader()
...
func (s *endpointPrintLabel) PrintLabel(ctx context.Context, id *uuid.UUID, PrintLabelArg *PrintLabelArg) (*PrintFile, *Response, error) {
	path := fmt.Sprintf("%s/export", id)
	rb := NewRequestBuilder[CustomTemplate](s.Endpoint, ctx).WithPath(path).WithBody(PrintLabelArg).setContentHeader()
	resp, err := rb.do(http.MethodPost)
	if err != nil {
		return nil, resp, err
	}
...
func (s *endpointPrintTemplates) GetEmbeddedTemplates(ctx context.Context) (*List[EmbeddedTemplate], *Response, error) {
...
func (s *endpointPrintTemplates) GetEmbeddedTemplateByID(ctx context.Context, id *uuid.UUID) (*EmbeddedTemplate, *Response, error) {
...
func (s *endpointPrintTemplates) GetCustomTemplates(ctx context.Context) (*List[CustomTemplate], *Response, error) {
...
func (s *endpointPrintTemplates) GetCustomTemplateByID(ctx context.Context, id *uuid.UUID) (*CustomTemplate, *Response, error) {

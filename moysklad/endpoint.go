...
func (s *endpointDeleteMany[T]) DeleteMany(ctx context.Context, entities *DeleteManyRequest) (*DeleteManyResponse, *resty.Response, error) {
...
func (s *endpointAccounts) UpdateAccounts(ctx context.Context, id uuid.UUID, accounts Slice[AgentAccount]) (*MetaArray[AgentAccount], *resty.Response, error) {
	path := fmt.Sprintf("%s/%s/accounts", s.uri, id)
	return NewRequestBuilder[MetaArray[AgentAccount]](s.client, path).Post(ctx, accounts)
}
...
func (s *endpointAttributes) DeleteAttributes(ctx context.Context, attributeList *DeleteManyRequest) (*DeleteManyResponse, *resty.Response, error) {
...
func (s *endpointFiles) DeleteFiles(ctx context.Context, id uuid.UUID, files *DeleteManyRequest) (*DeleteManyResponse, *resty.Response, error) {
...
func (s *endpointImages) DeleteImages(ctx context.Context, id uuid.UUID, images *DeleteManyRequest) (*DeleteManyResponse, *resty.Response, error) {
...
func (s *endpointPositions[T]) DeletePositionList(ctx context.Context, id uuid.UUID, list *DeleteManyRequest) (*DeleteManyResponse, *resty.Response, error) {
	path := fmt.Sprintf("%s/%s/positions/delete", s.uri, id)
	return NewRequestBuilder[DeleteManyResponse](s.client, path).Post(ctx, list)
}
...
func (s *endpointPositions[T]) CreateOrUpdatePositionTrackingCodes(ctx context.Context, id, positionID uuid.UUID, trackingCodes Slice[TrackingCode]) (*[]TrackingCode, *resty.Response, error) {
	path := fmt.Sprintf("%s/%s/positions/%s/trackingCodes", s.uri, id, positionID)
...
func (s *endpointPositions[T]) DeletePositionTrackingCodes(ctx context.Context, id, positionID uuid.UUID, trackingCodes Slice[TrackingCode]) (*DeleteManyResponse, *resty.Response, error) {
...
func (s *endpointStates) CreateOrUpdateStates(ctx context.Context, states []*State) (*[]State, *resty.Response, error) {
	path := fmt.Sprintf("%s/metadata/states", s.uri)

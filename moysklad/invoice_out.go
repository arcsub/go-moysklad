...
type InvoiceOut struct {
	...
	ID                   *string                        `json:"id,omitempty"`                   // ID Счета покупателю
...
func (invoiceOut InvoiceOut) GetID() string {
...
func (invoiceOut InvoiceOut) GetAccountID() string {
...
func (invoiceOut InvoiceOut) GetSyncID() string {
...
func (invoiceOut *InvoiceOut) SetSyncID(syncID string) *InvoiceOut {
...
// GetAccountID возвращает ID учётной записи.
func (invoiceOutPosition InvoiceOutPosition) GetAccountID() string {
...
func (invoiceOutPosition InvoiceOutPosition) GetID() string {
...
type InvoiceOutService interface {
	...
	CreatePositionMany(ctx context.Context, id string, positions ...*InvoiceOutPosition) (*Slice[InvoiceOutPosition], *resty.Response, error)
	...
	// Принимает контекст, ID документа и ID позиции.
	// Возвращает объект DeleteManyResponse, содержащий информацию об успешном удалении или ошибку.
	DeletePositionMany(ctx context.Context, id string, positions ...*InvoiceOutPosition) (*DeleteManyResponse, *resty.Response, error)
	...
	GetBySyncID(ctx context.Context, syncID string) (*InvoiceOut, *resty.Response, error)

...
func (retailSalesReturnPosition *RetailSalesReturnPosition) SetAssortment(assortment *AssortmentPosition) *RetailSalesReturnPosition {
	retailSalesReturnPosition.Assortment = assortment

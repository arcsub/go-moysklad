...
type CashOut struct {
	...
	ID             *string                  `json:"id,omitempty"`             // ID Расходного ордера
...
func (cashOut CashOut) GetAccountID() string {
...
func (cashOut CashOut) GetID() string {
...
func (cashOut CashOut) GetSyncID() string {
...
func (cashOut *CashOut) SetSyncID(syncID string) *CashOut {
...
type CashOutService interface {
	...
	GetBySyncID(ctx context.Context, syncID string) (*CashOut, *resty.Response, error)

...
func (s *storeService) CreateOrUpdateSlots(ctx context.Context, storeID uuid.UUID, slots Slice[Slot]) (*Slice[Slot], *resty.Response, error) {
	path := fmt.Sprintf("%s/%s/slots", s.uri, storeID)
	return NewRequestBuilder[Slice[Slot]](s.client, path).Post(ctx, slots)
}
...
func (s *storeService) DeleteSlots(ctx context.Context, storeID uuid.UUID, slots Slice[Slot]) (*DeleteManyResponse, *resty.Response, error) {
...
func (s *storeService) CreateOrUpdateZones(ctx context.Context, storeID uuid.UUID, zones Slice[Zone]) (*Slice[Zone], *resty.Response, error) {
	path := fmt.Sprintf("%s/%s/zones", s.uri, storeID)
	return NewRequestBuilder[Slice[Zone]](s.client, path).Post(ctx, zones)
}
...
func (s *storeService) DeleteZones(ctx context.Context, storeID uuid.UUID, zones Slice[Zone]) (*DeleteManyResponse, *resty.Response, error) {
